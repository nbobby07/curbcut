...
- Maintain a persistent authenticated Vercel deployment from M1/M2 onward. The current application commit, `09a342e` on `codex/hackathon-ready`, was built, deployed, and verified at <https://curbcut-one.vercel.app> as Vercel deployment `dpl_4D7xWmdFWrWfnY9nH3XUjVoSZNoy`.
